/* ============================================================
   Мини-лендинг «Мастер-классы» — логика
   - подстановка ссылок мессенджеров (плейсхолдеры)
...
(function () {
  ...
  // ---- КОНФИГ ----
  // Тег источника "mk" передаётся в Wazzup/CRM:
  //  - TG/MAX: придёт первым сообщением "/start mk" (видно менеджеру в чате)
